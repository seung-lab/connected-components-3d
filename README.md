...
<b>Fig. 1</b> How binary and multilabel connected components works. 2D images are shown for simplicity. (a) A binary image (white is foreground, black is background). (b) 4-connected CCL of binary image (c) 8-connected CCL of binary image (d) A multilabel image (e) 4-connected CCL of multilabel image (f) 8-connected CCL of multilabel image
</p>
